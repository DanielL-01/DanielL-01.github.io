document.addEventListener("DOMContentLoaded", ()=>{
	...
	const border = {
		...
		draw: function() {
			...
			const bottom = ctx.fillRect(0, this.height-this.size, this.width, this.height   )
	...
	class Snake {
		...
		checkCollision(head){
			...
			const wallCollison = leftCollision || topCollision || rightCollision||bottomCollision;
